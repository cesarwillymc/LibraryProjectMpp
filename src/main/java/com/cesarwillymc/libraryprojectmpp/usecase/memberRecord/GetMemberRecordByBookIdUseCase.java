...
public class GetMemberRecordByBookIdUseCase extends UseCaseParams<String, Resource<List<MemberRecord>>> {
    final private MemberRecordDataSource memberDataSource;

    public GetMemberRecordByBookIdUseCase(MemberRecordDataSource memberDataSource) {
